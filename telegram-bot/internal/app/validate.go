...
// normalizeName схлопывает лишние пробелы и обрезает строку по краям.
func normalizeName(s string) string {
	return strings.Join(strings.Fields(s), " ")
}

// validName проверяет, что строка похожа на ФИО: минимум два слова (фамилия и
// имя), есть буквы, разумная длина и это не команда.
